<?php
 ...
 class model_users extends model_system {
      function store($username,$pass,$hoten,$kichhoat,$urlhinh,$email,$anhien){ 
          //$sql = "INSERT INTO `nhasanxuat` (`idnsx`, `tennsx`, `thutu`, `anhien`) VALUES (NULL, '$ten', '$tt', '$ah');";
          $sql="INSERT INTO `user`(`iduser`, `username`, `pass`, `hoten`, `kichhoat`, `urlhinh`, `email`, `vaitro`, `anhien`) VALUES (NULL,'$username','$pass','$hoten','$kichhoat','$urlhinh','$email',0,'$anhien');";
          $kq= $this->execute($sql);
          return $kq;
      }
